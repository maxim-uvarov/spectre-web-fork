...
One known consumer is the air-gapped SSH signer `okpairgappedsigner`: it takes the 24 words with an empty passphrase, derives the BIP-39 seed and uses its first 32 bytes as an Ed25519 seed.
